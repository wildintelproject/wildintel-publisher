...
def test_b2share_prepare_self_contained_resizes_images_to_fit_max_zip_file(camtrapdp_dir, tmp_path):
    input_dir = camtrapdp_dir("trapper_out", include_private_media=False)
    output_dir = tmp_path / "b2share_out"
...
def test_b2share_prepare_self_contained_fails_when_still_over_max_zip_file(camtrapdp_dir, tmp_path, caplog):
    input_dir = camtrapdp_dir("trapper_out", include_private_media=False)
    output_dir = tmp_path / "b2share_out"
    ...
    assert "over B2SHARE's own" in caplog.text
